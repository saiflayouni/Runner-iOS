...
class RegisterController: UIViewController {
    ...
    // MARK: - UI Components
    private let headerView = AuthHeaderView(title_name_app :"Runner",title: "Sign Up", subTitle: "Create your account")
    ...
    */
    ...
    @objc func didTapSignUp() {
        ...
        AF.request("http://localhost:3000/user/register",
                   method: .post,
        ...
        .responseJSON { response in
            ...
            case .success(let value):
                ...
                if let json = value as? [String: Any],
                   let user = User(json: json) {
                    print("Signup request succeeded with user: \(user)")
            ...
            case .failure(let error):
                print("Signup request failed with error: \(error)")
                // handle error
            }
        }
    }
